        ...
        case 'brainly':
            {
                ...
                brain.searchWithMT("id", parameter).then(res => {
                    ...
                    conn.sendMessage(senderNumber, buttons, { quoted: message });
        ...
        case "ytmp3":
            {
                ...
                const mp3 = ytdown.ytmp3(parameter);
                const mp4 = ytdown.yt(parameter);
                ...
                if (mp3.title == "Not Found" || mp4.title == "Not Found") {
                    ...
                    const caption = mp3.title || mp4.title
                    const theButton = [
                        { index: 1, urlButton: { displayText: 'Download Mp4', url: mp4.link } },
                        { index: 2, urlButton: { displayText: 'Download Mp3', url: mp3.link } },
                    ]

                    const buttonMessage = {
                        caption: `Video *${caption}* siap di download\n\nsilakan klik tombol ini untuk membuka browser dan langsung mendownload video kamu 😊`,
                        footer: watermark,
                        templateButtons: theButton,
                        headerType: 1
                    }
