...
const languageList = "soon" //fs.readFileSync("../config/lang.txt", "utf-8");
const factList = JSON.parse(fs.readFileSync("./json/fact.json", "utf-8"));
const config = JSON.parse(fs.readFileSync('./config/config.json', 'utf-8'));
const quoteList = JSON.parse(fs.readFileSync("./json/quotes.json", "utf-8"));
